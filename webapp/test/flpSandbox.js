		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Supplementary_sales",
									"targetURL": "#supplementarysales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"supplementarysales-display": {
								"semanticObject": "supplementarysales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=supplementarysales",
									"url": sap.ui.require.toUrl("supplementarysales")
								}
							}
						}
					}
